  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
      <div class="container">
        ...
        <li class="nav-item ">
            <a class="nav-link active " href="listes_en_ordre.php">Liste des élèves en ordre</a>
        </li>
        <li class="nav-item ">
          ...
          <div class="  row mt-12 " style="margin-bottom:35%;">
            ...
            <div class="row mt-12" style="margin:10%;">
                <div class="input-field col white-text s11" >
                  <select  class="colorful-select dropdown-primary" id="classe "  name="classe"  style="color:white;ss"  >
